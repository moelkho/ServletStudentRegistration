           ...
           <!-- registration form-->
            ...
            <div class="col-sm8">
                <div class="panel-body">
                    ...
                    <table id="table-student" class="table table-responsive table-bordered" cellpadding="0" width="100%"  style="overflow-y: scroll; height:500px;">
                        <thead>
                            <tr>
                                <th>Student ID</th>
                                <th>Student Name</th>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href=""><i class="fa fa-pencil fa-lg"
